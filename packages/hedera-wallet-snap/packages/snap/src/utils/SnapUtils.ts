...
import {FEE_DIGIT_LENGTH, FEE_DISPLAY_REGEX, HBAR_ASSET_STRING} from "../types/constants";
...
export class SnapUtils {
  ...
  public static formatFeeDisplay(feeToDisplay:number, transfer:SimpleTransfer) {
    return text(
