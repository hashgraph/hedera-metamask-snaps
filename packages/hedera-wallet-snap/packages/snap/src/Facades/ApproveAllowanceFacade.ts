import {ApproveAllowanceAssetDetail, ApproveAllowanceRequestParams} from "../types/params";
...
export class ApproveAllowanceFacade {
    ...
    public static async approveAllowance(
        ...
        try {
            ...
            txReceipt = await approveAllowanceCommand.execute(hederaClient.getClient());
